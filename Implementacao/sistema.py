...
class Sistema(metaclass=SingletonMeta):
    def __init__(self, SisInterface, n):
        self.IdClass = f"Sistema n: {n}"  # n para verificacao do singleton
        self.interface = SisInterface
        self.pesquisa = pesquisa.Pesquisa(self.interface, self.IdClass)
